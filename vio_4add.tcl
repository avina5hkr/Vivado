...
#
# vio_4add.tcl: Tcl script for re-creating project 'vio_4add'
#
# Generated by Vivado on Wed Oct 17 19:09:36 +0530 2018
...
#
# 1. This project restoration tcl script (vio_4add.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Avinash/vio_4add/vio_4add.srcs/sources_1/new/vio_4add.v"
#    "C:/Users/Avinash/vio_4add/vio_4add.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "C:/Users/Avinash/vio_4add/vio_4add.srcs/constrs_1/new/vio_4add.xdc"
#
...
set files [list \
 [file normalize "${origin_dir}/vio_4add.srcs/sources_1/new/vio_4add.v" ]\
 [file normalize "${origin_dir}/vio_4add.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
set file "[file normalize "$origin_dir/vio_4add.srcs/constrs_1/new/vio_4add.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/vio_4add.xdc"
...
if { [get_files vio_4add.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Avinash/vio_4add/vio_4add.srcs/sources_1/new/vio_4add.v
}
...
# vio_4add
  ...
  # Create instance: vio_4add_0, and set properties
  set block_name vio_4add
  set block_cell_name vio_4add_0
  if { [catch {set vio_4add_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vio_4add_0 eq "" } {
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins vio_0/probe_out0] [get_bd_pins vio_4add_0/a]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins vio_0/probe_out1] [get_bd_pins vio_4add_0/b]
  connect_bd_net -net vio_0_probe_out2 [get_bd_pins vio_0/probe_out2] [get_bd_pins vio_4add_0/cin]
  connect_bd_net -net vio_4add_0_cout [get_bd_pins vio_0/probe_in1] [get_bd_pins vio_4add_0/cout]
  connect_bd_net -net vio_4add_0_sum [get_bd_pins vio_0/probe_in0] [get_bd_pins vio_4add_0/sum]
