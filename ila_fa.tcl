...
#
# ila_fa.tcl: Tcl script for re-creating project 'ila_fa'
#
# Generated by Vivado on Wed Oct 17 19:14:00 +0530 2018
...
#
# 1. This project restoration tcl script (ila_fa.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Avinash/ila_fa/ila_fa.srcs/sources_1/new/ila_fa.v"
#    "C:/Users/Avinash/ila_fa/ila_fa.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "C:/Users/Avinash/ila_fa/ila_fa.srcs/constrs_1/new/ila_fa.xdc"
#
...
set files [list \
 [file normalize "${origin_dir}/ila_fa.srcs/sources_1/new/ila_fa.v" ]\
 [file normalize "${origin_dir}/ila_fa.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
set file "[file normalize "$origin_dir/ila_fa.srcs/constrs_1/new/ila_fa.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/ila_fa.xdc"
...
if { [get_files ila_fa.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Avinash/ila_fa/ila_fa.srcs/sources_1/new/ila_fa.v
}
...
# ila_fa
  ...
  set b_0 [ create_bd_port -dir I -from 3 -to 0 b_0 ]
  ...
  # Create instance: ila_fa_0, and set properties
  set block_name ila_fa
  set block_cell_name ila_fa_0
  if { [catch {set ila_fa_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports a_0] [get_bd_pins ila_fa_0/a]
  connect_bd_net -net b_0_1 [get_bd_ports b_0] [get_bd_pins ila_fa_0/b]
  connect_bd_net -net cin_0_1 [get_bd_ports cin_0] [get_bd_pins ila_fa_0/cin]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins ila_0/clk]
  connect_bd_net -net ila_fa_0_cout [get_bd_pins ila_0/probe1] [get_bd_pins ila_fa_0/cout]
  connect_bd_net -net ila_fa_0_sum [get_bd_pins ila_0/probe0] [get_bd_pins ila_fa_0/sum]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35ticpg236-1L -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35ticpg236-1L -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
